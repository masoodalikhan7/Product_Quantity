...
data1 = pd.read_excel("C:/Users/masoodalikhan.k/Documents/New folder (3)/MARA_GROUP.XLSX")
...
dff['Product'] = dff['Material'].map(data1.set_index('MATNR')['Product'])


X = dff[['Material', 'month', 'Vendor', 'Product']]
Y = dff['Quantity']
...
import pickle
saved_model_p = open('saved_model_p.sav', 'wb')
pickle.dump(pipe, saved_model_p)
